...
export default function About() {
    return (
        <div className="w-full h-fit mb-30">
            <div className="flex gap-10 sm:w-[40%] w-[80%] mx-auto"> {/*About section */}
                <div className="w-fit p-8 h-auto  rounded-2xl" style={{
                    ...
                    <div className="flex gap-3 pt-2">{/*row alignment of children */}
                        ...
                        <div className="flex flex-col"><div>{/*coloumn alignment for name of colleges*/}
                ...
                <div className="flex flex-col gap-2">{/* column alignment for second column*/}
                    <div className="w-full p-5 h-fit rounded-2xl" style={{
                        ...
                        <p className=" text-center">Tech I Use</p>
                    ...
                    <div className="flex sm:flex-row flex-col  w-full gap-2">{/* row alignment for second row in second column*/}
                        <div className="sm:w-[50%] w-full h-full">{/*Styling the box */}
                        ...
                        <div className="w-full wrap-normal p-8 h-full  rounded-2xl" style={{
                            ...
                            <p> Eager to join a fast-paced team and contribute to real-world solutions.</p>
                        </div>
